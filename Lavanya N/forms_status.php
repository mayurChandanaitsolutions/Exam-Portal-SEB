...
<head>
    ...
    <style>
        ...
        /* Bottom Back Link */
        .back-link { display: inline-flex; align-items: center; color: #6b7280; font-weight: 600; text-decoration: none; transition: color 0.2s ease; background: white; padding: 10px 20px; border-radius: 50px; border: 1px solid #e5e7eb; }
        .back-link:hover { color: var(--seb-blue); border-color: var(--seb-blue); background: var(--seb-light); }
...
<body>
    ...
    <div class="container pb-5">
        ...
        <div class="mt-4">
            <a href="dashboard.php" class="back-link shadow-sm">
